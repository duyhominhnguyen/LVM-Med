...
If you want to build the dataset by yourself, after downloading the dataset, you can refer the script ```convert_to_coco.py``` inside folder object_detection and run it.
```bash
