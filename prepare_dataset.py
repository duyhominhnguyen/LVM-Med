...
def get_args():
    ...
    parser.add_argument('--dataset_name', '-ds', metavar='DS', type=str, default="", help='Name of dataset. Currently support: Kvasir, BUID, FGADR, MMWHS_MR_Heart and MMWHS_CT_Heart')
